...
def enroll_impl(name, username, email):
    ...
    body = (f'<p style="text-indent: 2em;">'
            ...
            f'<span style="color: rgb(96, 98, 102); background-color: rgb(255, 255, 255); font-size: 14px;">您好：'
            f'</span><span style="color: rgb(96, 98, 102); background-color: rgb(255, 255, 255); font-size: 14px;">'
            f'<strong>{name}</strong></span><span style="color: rgb(96, 98, 102); background-color: rgb(255, 255, 255); font-size: 14px;"> 您的账号已</span><span style="color: rgb(114, 192, 64); background-color: rgb(255, 255, 255); font-size: 14px;"><strong>成功注册</strong></span><span style="color: rgb(96, 98, 102); background-color: rgb(255, 255, 255); font-size: 14px;">。</span></p>'
