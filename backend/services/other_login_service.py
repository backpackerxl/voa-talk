...
def other_login(request, client_ip):
    ...
    if login_type == 'qqLogin':
        return other_login_impl.qq(request, code, redirect_uri, client_ip, bind_other_account)
    elif login_type == 'githubLogin':
        return other_login_impl.github(request, code, redirect_uri, client_ip, bind_other_account)
    else:
        return None
